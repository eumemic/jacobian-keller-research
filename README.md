...
| DC1 exploratory program | [`research/dc1-program/`](research/dc1-program/) | Exploratory, conditional, and non-peer-reviewed. Formal wall data and bounded certificates do not establish Weyl-pair realizability, DC1, or JC2. |
